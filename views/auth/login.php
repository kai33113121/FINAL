...
<head>
    ...
    <style>
        ...
        .login-background::before {
            ...
            width: 100%;
            height: 100%;
            background-image: url('https://i.pinimg.com/originals/1e/31/3a/1e313a58c726ed08e116c1607dfe3875.gif');
        ...
        .floating-book:nth-child(4) { bottom: 15%; right: 25%; animation-delay: 6s; }
        ...
        .login-left > *:nth-child(1) { animation-delay: 0.1s; }
        .login-left > *:nth-child(2) { animation-delay: 0.2s; }
        .login-left > *:nth-child(3) { animation-delay: 0.3s; }
        .login-left > *:nth-child(4) { animation-delay: 0.4s; }
        .login-left > *:nth-child(5) { animation-delay: 0.5s; }
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center" style="min-height: 100vh;">
        <div class="login-wrapper">
            ...
            <!-- Fondo artístico con la imagen existente -->
